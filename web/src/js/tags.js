...
riot.tag2('sign-in-email', '<section class="section" style="padding-top:11px;"> <div class="container"> <div class="card ghost-box-shadow"> <header class="card-header"> <p class="card-header-title"> Sign In </p> </header> <div class="card-content"> <form action="/ghost/sign/in" method="post"> <input class="input" placeholder="Email" style="margin-bottom: 22px;" name="mail" type="email"> <input class="input" placeholder="Password" type="password" name="password"> <div style="margin-top:22px;"> <button class="button is-warning" style="width:100%;" onclick="{clickSignin}" type="submit">Sign In</button> </div> </form> </div> </div> </div> </section>', 'sign-in-email .card { width: 333px; margin-left: auto; margin-right: auto; border-radius: 8px 8px 0px 0px; }', '', function(opts) {
     this.clickSignin = () => {
     };
